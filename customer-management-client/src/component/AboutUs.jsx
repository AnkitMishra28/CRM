  ...
  <div className="container mx-auto px-4">
    ...
    >
      ...
      <p className="text-lg text-gray-300 leading-relaxed">
        PerformaSuite is revolutionizing how businesses PerformaSuite. Since 2015, our mission has been to simplify PerformaSuite operations with secure, compliant, and user-friendly solutions. Backed by 10,000+ businesses globally, we fuse cutting-edge technology with expert support to empower teams of all sizes.
      </p>
    </motion.div>
    ...
    <div className="grid md:grid-cols-2 gap-10 mb-20">
      ...
      >
        ...
        <p className="text-gray-300">
          To become the world's most trusted PerformaSuite partner—automating processes so businesses can focus on what truly matters.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-gray-300">
          Empower companies with reliable, fast, and secure PerformaSuite systems through seamless automation and personalized support.
        </p>
      </motion.div>
    </div>
    ...
    <motion.div
      ...
      transition={{ duration: 0.5 }}
    >
      <h2 className="text-3xl md:text-4xl font-bold text-indigo-400 mb-6">Why Choose PerformaSuite?</h2>
      <p className="text-gray-300 max-w-3xl mx-auto">
        We simplify complexity with smart automation, offer 24/7 support, and maintain the highest security standards—making PerformaSuite stress-free and scalable.
      </p>
    </motion.div>
