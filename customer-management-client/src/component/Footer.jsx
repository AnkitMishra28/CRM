...
<footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4">PerformaSuite</h3>
            <p className="text-gray-400 mb-4">
              Simplifying PerformaSuite management for businesses worldwide with secure, efficient, and compliant solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: <a href="mailto:support@PerformaSuite.com" className="hover:text-blue-500 transition">support@payrollpro.com</a></li>
              <li>Phone: <a href="tel:+1234567890" className="hover:text-blue-500 transition">+1 (234) 567-890</a></li>
              <li>Address: 123 Business Ave, Suite 100, PerformaSuite City, PC 12345</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} PerformaSuite. All rights reserved.
          </p>
