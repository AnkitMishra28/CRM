        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-center">
              ...
              <a href="mailto:support@PerformaSuite.com" className="hover:text-blue-400 transition">
                support@PerformaSuite.com
              </a>
            </li>
            <li className="flex items-center">
              <span className="mr-2">📞</span>
            ...
            <li className="flex items-center">
              <span className="mr-2">📍</span>
              123 Business Ave, Suite 100, PerformaSuite, PC 12345
            </li>
          </ul>
        </div>
